...
const ProfileModel = ({setShowEdit}) => {
  ...
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/50 '>
        <div className='max-w-xl mx-auto sm:py-6'>
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                <form className='space-y-4' onSubmit={e =>  toast.promise(
                    ...
                    <div>
                        ...
                        <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' value={editForm.full_name} onChange={(e)=>setEditForm({...editForm, full_name: e.target.value})} placeholder='Enter your full name'/>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' value={editForm.username} onChange={(e)=>setEditForm({...editForm, username: e.target.value})} placeholder='Enter a username'/>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea rows={3} className='w-full p-3 border border-gray-200 rounded-lg' value={editForm.bio} onChange={(e)=>setEditForm({...editForm, bio : e.target.value})} placeholder='Enter a short bio'/>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' value={editForm.location} onChange={(e)=>setEditForm({...editForm, location: e.target.value})} placeholder='Enter your location'/>
                    </div>
                    ...
                    <div className='flex justify-end space-x-3 pt-6'>
                        ...
                        <button type='submit ' className='px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white hover:from-indigo-600 hover:to-purple-700 rounded-lg transition cursor-pointer'>Save Changes</button>
                    </div>
                </form>
            </div>
        </div>
